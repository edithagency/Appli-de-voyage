...
const PAYS_PERMIS = [
  { pays: 'États-Unis',         emoji: '🇺🇸', valide: true,  idp: 'recommandé',   duree: '1 an',     note: 'Le permis FR est accepté dans la plupart des États. Certains États (Connecticut, Caroline du Sud) exigent un Permis International de Conduire (PIC). Fortement recommandé pour la location de voiture.' },
  { pays: 'Canada',             emoji: '🇨🇦', valide: true,  idp: 'recommandé',   duree: '6 mois',   note: 'Permis FR accepté 6 mois. Au-delà, Permis International de Conduire (PIC) ou permis local requis. Le PIC est recommandé pour la location.' },
  ...
  { pays: 'Japon',              emoji: '🇯🇵', valide: false, idp: 'obligatoire',  duree: null,       note: 'Le Permis International de Conduire (PIC) n\'est pas reconnu au Japon (non signataire de la Convention de Vienne 1968). Il faut une traduction JAF (Japan Automobile Federation), valable 1 an. Depuis mars 2025, la traduction doit être demandée au Japon directement.' },
  { pays: 'Australie',          emoji: '🇦🇺', valide: true,  idp: 'recommandé',   duree: '3 mois',   note: 'Permis FR accepté 3 mois accompagné d\'une traduction en anglais ou d\'un Permis International de Conduire (PIC). Le PIC est exigé par la plupart des loueurs.' },
  ...
  { pays: 'Mexique',            emoji: '🇲🇽', valide: true,  idp: 'recommandé',   duree: '6 mois',   note: 'Le permis français est généralement accepté. Le Permis International de Conduire (PIC) est recommandé, parfois exigé par les loueurs pour activer la couverture assurance.' },
  { pays: 'Brésil',             emoji: '🇧🇷', valide: true,  idp: 'recommandé',   duree: '6 mois',   note: 'Permis FR reconnu. La plupart des loueurs exigent un Permis International de Conduire (PIC) pour formaliser la couverture assurance.' },
  ...
  { pays: 'Vietnam',            emoji: '🇻🇳', valide: false, idp: 'non suffisant', duree: null,      note: 'Depuis janvier 2025, aucun permis étranger n\'est reconnu pour la voiture. Pour les scooters jusqu\'à 125cc, le Permis International de Conduire (PIC) modèle 1968 + permis moto FR peut être accepté. Le modèle 1949 n\'est pas reconnu.' },
  ...
  { pays: 'Émirats arabes unis',emoji: '🇦🇪', valide: false, idp: 'obligatoire',  duree: null,       note: 'Un Permis International de Conduire (PIC) est obligatoire pour louer un véhicule aux Émirats (depuis 2007). Il doit être délivré par une préfecture française. Permis FR seul non accepté.' },
]
