...
const OUTILS = [
  {
    ...
    description: 'Combien en monnaie locale ?',
    premium: false,
  },
  {
    id: 'tailles',
    ...
    description: 'Ta taille partout dans le monde.',
    premium: false,
  },
  {
    id: 'horaire',
    ...
    description: 'Quelle heure là-bas ?',
    premium: false,
  },
  {
    id: 'bagages',
    ...
    description: 'Ce que tu peux emporter.',
    premium: false,
  },
  {
    id: 'urgences',
  ...
  },
  {
    ...
    emoji: '🚗',
    titre: 'Guide permis',
    description: 'Ton permis est-il valable ?',
    premium: true,
  },
  {
    id: 'medicaments',
    ...
    description: 'Tu cherches un médicament ?',
    premium: true,
  },
  {
    id: 'budget',
