...
import { sauvegarderCompagnie, sauvegarderCompagnieParticipant } from './bagages-actions'

export default function BagagesSection({
  voyageId,
  compagnieInitiale,
  participantId,
}: {
  voyageId: string
  compagnieInitiale: string | null
  participantId?: string | null
}) {
  const [compagnieId, setCompagnieId] = useState(compagnieInitiale)
  ...
  function handleSelect(id: string) {
    ...
    setSearch('')
    if (participantId) {
      startTransition(() => sauvegarderCompagnieParticipant(participantId, id))
    } else {
      startTransition(() => sauvegarderCompagnie(voyageId, id))
    }
  }
