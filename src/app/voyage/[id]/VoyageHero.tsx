...
export default function VoyageHero({
  ...
  return (
    <>
      ...
      {/* Contrôles + titre : couche fixe, ne bouge jamais */}
      <div style={{ position: 'sticky', top: 0, height: MIN_H, marginTop: -MIN_H, zIndex: 20 }}>
        <Link href="/dashboard"
          style={{ position: 'absolute', top: 12, left: 14, width: 32, height: 32, borderRadius: '50%', background: 'rgba(255,255,255,0.9)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 15, color: '#111827', backdropFilter: 'blur(4px)' }}>
          ←
        </Link>

        {isOrganisateur && (
          <div style={{ position: 'absolute', top: 12, left: 54 }}>
